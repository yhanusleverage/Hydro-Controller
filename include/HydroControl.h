...
public:
    ...
    // Sensores de nível capacitivos (PCF1 - 0x20)
    bool readCapacitiveSensor(int sensorIndex); // Ler sensor capacitivo (0-7)
    bool* getAllCapacitiveSensors(); // Obter todos os estados dos sensores capacitivos
...
private:
    ...
    // Estados dos sensores capacitivos (PCF1 - 0x20)
    bool capacitiveSensorStates[8]; // Estados dos 8 sensores capacitivos
